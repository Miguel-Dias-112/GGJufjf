...
export const Militar = criarInimigo('Militar',[criarFala("HAHAHA BRASIL!!",0),criarFala("Se continuar assim, você vai acabar servindo...",1),criarFala("Que isso, seu bizonho?",2)]

export const Padre = criarInimigo('Padre',[criaMaisrFala("Hahaha, Que piada divina!",0),criarFala("Que Deus ande contigo",1),criarFala("Que horror, Deus perdoe seus pecados",2)])